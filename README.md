...
Route `http://mailer.press/health` provides health check for database, Redis, storage and logging.
...
Please see Mailer Module [README file](./vendor/remp/mailer-module/README.md).
